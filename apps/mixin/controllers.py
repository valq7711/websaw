...
@app.route('about')
@app.use(ctxd.menu, ctxd.track_visited, ut.about)  # note there is no session, but it used!
def about(ctx: Context):
    ret = dict(mixin = 'http://127.0.0.1:8000/mixin',
                index = 'http://127.0.0.1:8000/mixin/index',
                upytl = 'http://127.0.0.1:8000/mixin/upytl_demo',
                welcome='http://127.0.0.1:8000/mixin/welcome',
                template_overwrite= 'http://127.0.0.1:8000/mixin/mixin_template_overwritten',
                info= 'http://127.0.0.1:8000/mixin/info/app'
                )
