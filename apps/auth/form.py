...
import copy
import os
from ombott import request, response
...
class Form(object):
        ...
        **kwargs
        ...
        if request.method == 'GET':
            ...
            for f in self.table.fields:
                print('Field is' , f, 'type is ', self.table[f].type)
    ...
    def create_form(self):
        return '''<div class="columns"> Hello Mud sucker how the fuck are you ???? </div>'''
